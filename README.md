...
A simple GitHub profile viewer that uses the GitHub API to view details of a specific GitHub profile by its username.
...
**Current features:**
- Input GitHub profile username
- Display profile details like display picture, repositories, etc
...
```bash
git clone https://github.com/devsoc-aec/github-profile-viewer.git
```
